...
void main() {
  group("ProjectCheckboxList", () {
    ...
    testWidgets(
      "displays the loading placeholder if project checkbox view models are null",
      (WidgetTester tester) async {
        final projectGroupsNotifier = ProjectGroupsNotifierMock();
    ...
    testWidgets(
      "displays the text placeholder with the no configured projects text if project checkbox view models are empty",
      (WidgetTester tester) async {
        final projectGroupsNotifier = ProjectGroupsNotifierMock();
